...
type DecryptorEntiry struct {
	rsaPriv *rsa.PrivateKey
}

func NewDecryptor(path string) (*DecryptorEntiry, error) {
	decryptor := &DecryptorEntiry{}
...
func (d *DecryptorEntiry) loadPrivateKey(path string) error {
...
func (d *DecryptorEntiry) DecryptMessage(encryptedMessage string) (string, error) {
